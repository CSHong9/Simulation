...
## The reference for the model setting and iteratiobn flow comes from James Kitts' 2016 simulation class. I change some of the logic to fit closely the simulation procedure in the original paper. I also decrease the number of repetitions to give a quick illustration.
